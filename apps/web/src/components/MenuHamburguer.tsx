    ...
    <>
      ...
      <div className="fixed top-0 left-0 h-full w-80 bg-[#0a0a0a]/90 backdrop-blur-xl border-r border-[#00e5ff]/20 shadow-2xl z-50 transform transition-transform duration-500 ease-out animate-slide-in">
        ...
        <div className="relative h-28 bg-gradient-to-br from-[#00e5ff]/15 via-transparent to-transparent flex items-center justify-between px-6">
          <div>
            <h2 className="text-3xl font-light text-[#00e5ff] tracking-wider drop-shadow-[0_0_10px_#00e5ff]">
              Menu
            </h2>
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-full hover:bg-[#00e5ff]/20 transition-all duration-300 group"
          >
            <FiX
              size={28}
              className="text-[#00e5ff] group-hover:rotate-90 transition-transform duration-300"
            />
          </button>
        </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <item.icon
                  size={22}
                  color={iconColor}
                  className="transition-all duration-300 group-hover:scale-110 group-hover:drop-shadow-[0_0_8px_#00e5ff]"
                />

                <span className="text-gray-300 group-hover:text-white font-medium tracking-wide text-lg">
                  {item.label}
                </span>
              </div>
        ...
        <div className="absolute bottom-6 left-0 right-0 text-center">
          <p className="text-xs text-[#00e5ff]/30 tracking-wider">
            MecPro • v2.0 • futuro
          </p>
        </div>
      </div>
